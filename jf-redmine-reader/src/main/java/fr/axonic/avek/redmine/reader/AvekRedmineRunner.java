package fr.axonic.avek.redmine.reader;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.taskadapter.redmineapi.RedmineException;
import fr.axonic.avek.redmine.reader.analysis.WikiProjectProcessor;
import fr.axonic.avek.redmine.reader.analysis.approvals.extraction.ApprovalExtractor;
import fr.axonic.avek.redmine.reader.analysis.approvals.extraction.AxonicApprovalExtractor;
import fr.axonic.avek.redmine.reader.analysis.notifications.NotificationSystem;
import fr.axonic.avek.redmine.reader.analysis.notifications.NotificationSystemFactory;
import fr.axonic.avek.redmine.reader.analysis.reporting.AnalysisFormatter;
import fr.axonic.avek.redmine.reader.analysis.reporting.AnalysisReport;
import fr.axonic.avek.redmine.reader.configuration.*;
import fr.axonic.avek.redmine.reader.transmission.bus.AvekBusTransmitter;
import fr.axonic.avek.redmine.reader.transmission.bus.AvekBusTransmitterFactory;
import fr.axonic.avek.redmine.reader.users.bindings.IdentityBinder;
import fr.axonic.avek.redmine.reader.users.bindings.SimpleIdentityBinder;
